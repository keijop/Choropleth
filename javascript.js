...
let colorScale = d3.scaleQuantize()
					...
					.range(["#563C08","#4C3F0A","#43430B","#39460D","#2F490F","#254C10","#1C5012","#125313","#085615"].reverse())
...
Promise.all([    
	...
	fetch('https://raw.githubusercontent.com/keijop/counties_geojson/main/olkyl-mo4et.json')
	])
